"""Climate Modelling Part 2 (Bremen, 2018): Diagnostic for exercise 4."""
...
def main(cfg):
    ...
    plot_path = os.path.join(cfg['plot_dir'], 'exercise_4.png')
    ...
    for (dataset, data) in grouped_input_data.items():
        ...
        # Plot
        iris.quickplot.plot(rcp85_cube.coord('year'), rcp85_cube, label=dataset)
